    ...
    voices: List[Dict[str, Any]] = [
        {
            ...
            "biography": "Harishchand Mishra has served as a dedicated caretaker and guide at Lal Bagh Palace, sharing intricate details about the palace's construction, architecture, and daily life of the Holkar royalty. His detailed narrations preserve the living memory of the palace's European-inspired design, Italian marble installations, underground tunnels, and the royal family's lifestyle spanning over 170 years of history.",
        ...
        },
        {
            ...
            "biography": "Ankit Verma is an independent researcher specializing in Maratha architecture and heritage conservation based in Delhi, originally from Indore. He focuses on cultural history and has been instrumental in documenting Rajwada's architectural evolution and its role in shaping Indore's urban identity.",
        ...
        },
        {
            ...
            "biography": "Pushyamitra Bhargava served as Mayor of Indore from 2019 to 2024, during which time he championed several heritage conservation initiatives including the revival of Rajwada and Lalbagh Palace. His administration prioritized the preservation of the city's historic monuments while promoting sustainable urban development and public engagement through heritage walks and light-and-sound shows.",
