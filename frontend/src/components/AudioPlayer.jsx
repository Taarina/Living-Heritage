    ...
    <div className="space-y-4" data-testid={testId || VOICES.audioPlayer}>
      ...
      <div className="flex items-center gap-6">
        <button
          ...
          className="w-12 h-12 flex items-center justify-center border border-archive-text/20 hover:border-archive-olive hover:bg-archive-secondary transition-smooth"
        >
          {isPlaying ? (
        ...
        <div className="flex-1 space-y-2">
          ...
          <div className="flex justify-between text-xs font-mono text-archive-text/60">
